...
track3 = Track.new(title: "Alors on danse", artist: "Stromae", url_preview: "https://cdns-preview-1.dzcdn.net/stream/c-101e682b510b3693698379939bf12c48-10.mp3", playlist_id: playlist2.id)
track4 = Track.new(title: "Marcia Baïla", artist: "Rita Mitsouko", url_preview: "https://cdns-preview-d.dzcdn.net/stream/c-de63cf69f3dcb9f03b9fe6fdb5ea19b9-3.mp3", playlist_id: playlist2.id)
track5 = Track.new(title: "Allumer le feu", artist: "Johnny Hallyday", url_preview: "https://cdns-preview-b.dzcdn.net/stream/c-b4639561980525a1a685c5ed396f45ee-7.mp3", playlist_id: playlist2.id)
track6 = Track.new(title: "Le bilan", artist: "Nèg' Marrons", url_preview: "https://cdns-preview-7.dzcdn.net/stream/c-7148d1048d4211736a61898c98a318af-4.mp3", playlist_id: playlist4.id)
